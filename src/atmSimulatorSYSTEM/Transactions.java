...
public class Transactions extends JFrame implements ActionListener{
	// isme ek label aur 7 button chahiye 
	 JLabel l1;
	    ...
	    Transactions(){
	        ...
	        add(b7);
	        // 7 button pe action listener lagaya 
	    ...
	    public void actionPerformed(ActionEvent ae){
	        ...
	        if(ae.getSource()==b1){ 
	            ...
	            // ISME Ek dialog khulega aur enter pin ke baare me poonchhega
