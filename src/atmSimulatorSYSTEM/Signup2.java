...
public class Signup2  extends JFrame implements ActionListener {
	//isme 12 label hain
	  JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12;
	    ...
	    // ab signup2 constructure banaya 
	    Signup2(){
	...
	// button ko define kuiya hai         
	        ...
	        add(b);
	      // next par action listener lagaya hai  
...
// action event ke liye actionPerformed method lagana padta hai
	    public void actionPerformed(ActionEvent ae){
	        ...
	        // ye upar waale form number text ke liye hai
	        String j = t3.getText();
